...
interface IStakingLocking {
    ...
    function decreaseLockAmount(address _account, uint256 _newAmount) external;
    ...
    function canUnlock(address _account, address _lockManager) external view returns (bool);
}
